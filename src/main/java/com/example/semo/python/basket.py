...
class Paint(object):
    ...
    def __init__(self):
        self.root = Tk()
        self.root.title('Scratch-Styling')
        ...
        self.brush_logo = ImageTk.PhotoImage(Image.open('brush2.png'))
        ...
        self.color_logo = ImageTk.PhotoImage(Image.open('color.jpg'))
        ...
        self.eraser_logo = ImageTk.PhotoImage(Image.open('brush.png'))
